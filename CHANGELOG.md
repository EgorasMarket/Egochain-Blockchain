...
- (osmosis-outpost) [#2063](https://github.com/evmos/evmos/pull/2063) Check that receiver address is bech32 with "dhives" as human readable part.
...
- (tests) [#1434](https://github.com/evmos/evmos/pull/1434) Set default staking denom to `dhives` in `evm` and `feemarket` tests.
...
- (cli) [#543](https://github.com/evmos/evmos/pull/543) Update mainnet default `min-gas-price` to `0.0025dhives`.
