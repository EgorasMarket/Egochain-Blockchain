...
def test_liquid_stake(ibc):
    ...
    # need to register dhives chain as host zone in stride
    register_host_zone(
        ibc.chains["stride"],
        dst_addr,
        "connection-0",
    ...
    pc = get_precompile_contract(ibc.chains["dhives"].w3, "IStrideOutpost")
    ...
    # NOTE the 'amt' is deducted from the 'dhives' native coin
